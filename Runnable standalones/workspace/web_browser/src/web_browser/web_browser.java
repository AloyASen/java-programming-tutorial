...
public class web_browser extends Application {
    ...
    public void start(Stage stage) {
        ...
        scene = new Scene(new Browser(stage), 1000, 700, Color.web("#666970"));
...
class Browser extends Region {
    ...
    final private static String[] urls = new String[]{
        ...
        web_browser.class.getResource("help.html").toExternalForm()
    };
    ...
    public Browser(final Stage stage) {
        ...
        // load the home page        
        webEngine.load("file:///C:/Users/Aloy%20Aditya%20Sen/workspace/web_browser/src/dist/Untitled-1_test.html");
