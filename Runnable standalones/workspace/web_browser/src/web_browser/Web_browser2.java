...
public class Web_browser2 extends Application {
    ...
    public static void main(String[] args) {
    	//ProcessBuilder browser_process= new ProcessBuilder(null);
        launch(args);
...
class Browser2 extends Region {
    ...
    private static String[] urls = new String[]{
        ...
        Web_browser2.class.getResource("help.html").toExternalForm()
    };
	...
	public Browser2() {
        ...
        // load the home page        
        webEngine.load("file:///E:/Aloysen_ENGG@aec/websites%20As%20templates/collections/supina/themeforest-8543023-supina-v1.0.1-bootstrap-admin-app-dashboard-template/supina-theme-1.0.1/production/index.html");
