...
public class ICE_ec implements ElectionCouncil {
    ...
    private boolean checkMessage(String msg) {
        char[] EmblemArray = ICE.emblem.toCharArray();
        /**
         * this is a brute force technique and will be improved if required
         */

        for (char emlm : EmblemArray){
            if(containsChar(msg, emlm) && (occurances(msg, emlm, 0) >= occurances(ICE.emblem, emlm, 0))){
